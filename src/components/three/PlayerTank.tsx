    ...
    <group ref={tankRef} scale={[0.8, 0.8, 0.8]}>
      <mesh castShadow receiveShadow onPointerOver={handlePointerOver} onPointerOut={handlePointerOut}>
        ...
        <mesh position={[0, 0.2, 0]}>
          ...
          <meshStandardMaterial ref={materialRef} color="#4a5d3a" roughness={0.8} metalness={0.2} emissive="#2a3520" emissiveIntensity={0.5} />
        </mesh>

        {/* Sloped front armor */}
        <mesh position={[2.5, 0.4, 0]} rotation={[0, 0, -0.3]}>
          <boxGeometry args={[0.8, 0.6, 2.8]} />
          <meshStandardMaterial color="#4a5d3a" roughness={0.8} metalness={0.2} />
        </mesh>
        ...
        <mesh position={[0.1, 0.4, 1.41]}>
          ...
          <meshStandardMaterial map={useLoader(THREE.TextureLoader, bgSource)} roughness={0.8} />
        </mesh>
        <mesh position={[0.1, 0.4, -1.41]}>
          <boxGeometry args={[0.8, 0.4, 0.0]} />
          <meshStandardMaterial map={useLoader(THREE.TextureLoader, bgSource)} roughness={0.8} />
        ...
        <group ref={turretRef} position={[0, 0.2, 0]}>
          ...
          <mesh position={[1.0, 0.9, 0]}>
            ...
            <meshStandardMaterial color="#3a4a2a" roughness={0.9} metalness={0.1} />
          </mesh>
            ...
            {isFiring && (
              <>
                <mesh position={[5, 0.9, 0]}>
                  ...
                  <meshStandardMaterial color="#ffff00" emissive="#ff4400" emissiveIntensity={3} />
                </mesh>
          ...
          <mesh position={[0.3, 1.35, 0]}>
            ...
            <meshStandardMaterial color="#2a3520" roughness={0.9} metalness={0.1} />
          </mesh>
          {/* Helmet strap */}
          <mesh position={[0.3, 1.25, 0]}>
